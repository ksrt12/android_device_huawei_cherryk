...
ifneq ($(TARGET_PREBUILT_KERNEL),)
 PRODUCT_COPY_FILES += device/huawei/cherryplus/kernel:kernel
endif
#Ramdisk
PRODUCT_COPY_FILES += \
		device/huawei/cherryplus/rootdir/fstab.hi6210sft:root/fstab.hi6210sft \
		device/huawei/cherryplus/rootdir/init.connectivity.rc:root/init.connectivity.rc \
		device/huawei/cherryplus/rootdir/init.hi6210sft.rc:root/init.hi6210sft.rc \
		device/huawei/cherryplus/rootdir/init.hwconfig.rc:root/init.hwconfig.rc \
		device/huawei/cherryplus/rootdir/ueventd.hi6210sft.rc:root/ueventd.hi6210sft.rc \
		device/huawei/cherryplus/rootdir/init.hi6210sft.usb.rc:root/init.hi6210sft.usb.rc \
		device/huawei/cherryplus/rootdir/sbin/oeminfo_nvm_server:root/sbin/oeminfo_nvm_server \
		device/huawei/cherryplus/rootdir/sbin/volisnotd:root/sbin/volisnotd \
		device/huawei/cherryplus/rootdir/sbin/teecd:root/sbin/teecd \
...
PRODUCT_COPY_FILES += \
		...
		device/huawei/cherryplus/etc/rild.rc:system/etc/init/rild.rc
